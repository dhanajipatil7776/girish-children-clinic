...
const HERO_IMG =
  "https://static.prod-images.emergentagent.com/jobs/a70baf13-7455-4258-8f13-c9d040709667/images/eddbf463aa839c0220c02728cb7228d20d208de9ab86a26c8b952b3e09255a09.png";
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 relative fade-up" style={{ animationDelay: "120ms" }}>
            <div className="relative rounded-[2rem] overflow-hidden border border-slate-100 shadow-[0_25px_80px_-15px_rgba(2,132,199,0.25)] bg-white">
              <img
                src={HERO_IMG}
                alt="Pediatrician with a happy child"
            ...
            <div className="animate-float-soft absolute -bottom-5 -left-3 sm:left-6 bg-white rounded-2xl border border-slate-100 shadow-xl px-4 py-3 flex items-center gap-3">
              ...
              <div>
                <div className="font-heading font-extrabold text-slate-900">4.7★</div>
                <div className="text-xs text-slate-500">Loved by parents</div>
              </div>
            </div>

            {/* Floating experience badge */}
            <div className="animate-float-soft absolute -top-3 -right-3 sm:-right-2 bg-sky-500 text-white rounded-2xl shadow-xl px-4 py-3" style={{ animationDelay: "1.5s" }}>
              <div className="font-heading font-extrabold text-xl leading-none">{CLINIC.experienceYears}+</div>
              <div className="text-[11px] uppercase tracking-widest opacity-90">Years Experience</div>
            </div>
          </div>
        </div>
      </div>
